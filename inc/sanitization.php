 ...
 */
function kamino_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function kamino_sanitize_css( $css ) {
 ...
 */
function kamino_sanitize_email( $email, $setting ) {
 ...
 */
function kamino_sanitize_hex_color( $hex_color, $setting ) {
	// Sanitize $input as a hex value without the hash prefix.
 ...
 */
function kamino_sanitize_html( $html ) {
 ...
 */
function kamino_sanitize_image( $image, $setting ) {
 ...
 */
function kamino_sanitize_nohtml( $nohtml ) {
 ...
 */
function kamino_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function kamino_sanitize_number_range( $number, $setting ) {
 ...
 */
function kamino_sanitize_select( $input, $setting ) {
 ...
 */
function kamino_sanitize_url( $url ) {
